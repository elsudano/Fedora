#!/bin/bash
# Titulo:       Instalación y configuración open versión
# Fecha:        23/12/16
# Autor:        Carlos de la Torre
# Versión:      1.0
# Descripción: Instalación de Java versión open source, la actualización de esta versión es mas sencilla por que se realiza a tráves de los repositorios de fedora
# Opciones: Ninguna
# Uso: install-open-java.sh
