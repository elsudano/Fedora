#!/bin/bash
# Titulo:       Instalación y configuración de MariaDB, base de datos libre
# Fecha:        23/12/16
# Autor:        Carlos de la Torre
# Versión:      1.0
# Descripción: Instalación de MySQL versión libre, la ventaja es que se actualiza a tráves de los repositorios
# Opciones: Ninguna
# Uso: install-java.sh
